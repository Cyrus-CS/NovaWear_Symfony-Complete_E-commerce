 ...
 */
final class Version20260225193927 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product DROP product_id, CHANGE rating_count rating_count INT DEFAULT 0');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE product ADD product_id BINARY(16) DEFAULT NULL, CHANGE rating_count rating_count INT DEFAULT 0 NOT NULL');
