 ...
 */
final class Version20260227184429 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE order_item CHANGE product_id_id product_id BINARY(16) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE order_item CHANGE product_id product_id_id BINARY(16) DEFAULT NULL');
